      ...
      <div className="document-list">
        {loading ? (
          ...
          <div className="empty-state">
            <FileText size={38} style={{ opacity: 0.3, marginBottom: 10 }} />
              ...
              {doc.file_path && (
                <a
                  ...
                  style={{
                    ...
                    border: 0, background: "linear-gradient(135deg,#4f46e5,#7c3aed)",
                    color: "white", borderRadius: 9, padding: "8px 14px",
